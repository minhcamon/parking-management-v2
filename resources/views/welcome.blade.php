...
<body class="flex flex-col justify-center items-center text-center min-h-screen">
    ...
    <div class="hero max-w-[800px] p-8 z-10">
        ...
        <p class="text-xl text-muted mb-12 leading-[1.6]">The ultimate modern parking management system. Seamlessly register vehicles, process transactions, and manage your facilities in real time.</p>
